      ...
      <div className="d-flex justify-content-between align-items-end mb-4">
        ...
        <div className="d-flex align-items-center gap-3">
          ...
          <button
            ...
            style={{ background: 'var(--accent-sage)', padding: '0.6rem 1.2rem', borderRadius: '8px' }}
            onClick={createNote}
          >
      ...
      <div className="notes-dashboard">
        ...
        <div className="paper-card notes-list-card">
          <div className="notes-list-header">
            <span className="fw-medium" style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                ...
                >
                  ...
                  <div className="note-item-content text-truncate">
                    ...
                    <div className="note-item-date">
                      {new Date(note.updatedAt || Date.now()).toLocaleString('en-US', {
                  ...
                  <div
                    ...
                    style={{
                      ...
                      flexShrink: 0,
                      opacity: activeNote?._id === note._id ? 1 : 0
                    }}
                  ></div>
                </button>
              ))
          ...
          <div className="text-center p-2 border-top text-muted"
            style={{ fontSize: '0.75rem', borderColor: 'var(--border)' }}>
            {filteredNotes.length} notes
          </div>
        </div>

        {/* ── CENTER: EDITOR — binding is flex sibling ── */}
        <div className="editor-wrapper">

          {/* Binding: flex child, always full height */}
          <div className="editor-spiral-binding"></div>
          ...
          <div className="editor-notebook">
            {activeNote ? (
              ...
              <div className="d-flex flex-column align-items-center justify-content-center h-100 text-muted">
                ...
                <h4 className="mt-3" style={{ fontFamily: 'var(--font-serif)' }}>
